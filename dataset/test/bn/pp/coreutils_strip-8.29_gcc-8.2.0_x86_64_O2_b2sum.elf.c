                                                ...
                                                *rax_35 = 0;
                                                ...
                                                else if ((data_60e306 == 0 || (data_60e306 != 0 && var_e0 == 0)))
                                                {
                                                    ...
                                                    if ((((((rdx_24 == 0 || ((rdx_24 != 0 && *(rdi_18 + (*(r8_8 + (r15_1 << 1)) << 2)) == *((rsi_10 & 0xf) + "0123456789abcdef")) && *(rdi_18 + (*((r8_8 + (r15_1 << 1)) + 1) << 2)) == *((rax_57 & 0xf) + "0123456789abcdef"))) && rax_83 == 0) && rax_84 == 0) || ((rdx_24 != 0 && (*(rdi_18 + (*(r8_8 + (r15_1 << 1)) << 2)) != *((rsi_10 & 0xf) + "0123456789abcdef") || (*(rdi_18 + (*(r8_8 + (r15_1 << 1)) << 2)) == *((rsi_10 & 0xf) + "0123456789abcdef") && *(rdi_18 + (*((r8_8 + (r15_1 << 1)) + 1) << 2)) != *((rax_57 & 0xf) + "0123456789abcdef")))) && data_60e308 == 0)) && data_60e305 == 0))
                                                    {
                                                        rsi_8 = &data_409ed0;
                                                    label_402396:;
                                                        __printf_chk(1, ": %sn", dcgettext(nullptr, rsi_8, 5));
                                                    }
                                                }
                                                var_100_1 = r14;
                                            } while ((*r13_1 & 0x30) == 0);
...
int64_t j_sub_402e9a()
{
    /* tailcall */
    return sub_402e9a();
}

uint64_t sub_402f30(char* arg1)
{
    char* rbx = arg1;
...
char* sub_402f90(char* arg1, void* arg2)
{
    void* rax = &arg1[1];
    int64_t rdx = 0;
    void* r8 = (arg2 - 1);
...
void sub_403020(char* arg1, char arg2)
{
    char* rbx = arg1;
    if (arg2 == 0)
    {
...
uint64_t sub_4030d0(char* arg1, int64_t arg2, char* arg3)
{
    int64_t rcx = 2;
...
noreturn int64_t sub_403280(int32_t arg1) 
{
    ...
    {
        __printf_chk(1, dcgettext(nullptr, "Usage: %s [OPTION]... [FILE]...n…", 5), rbp, "BLAKE2", 0x200);
        fputs_unlocked(dcgettext(nullptr, "nWith no FILE, or when FILE is …", 5), stdout);
        fputs_unlocked(dcgettext(nullptr, "n  -b, --binary         read in…", 5), stdout);
        ...
        fputs_unlocked(dcgettext(nullptr, "nThe following five options are…", 5), stdout);
        ...
        __printf_chk(1, dcgettext(nullptr, "nThe sums are computed as descr…", 5), "RFC 7693");
        ...
        if (rbp_1 == 0)
        {
            ...
            if ((rax_27 == 0 || (rax_27 != 0 && rax_28 == 0)))
            {
                rbp_1 = "b2sum";
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "b2sum");
            }
        }
        else
        {
...
int64_t sub_403680(void* arg1, int64_t arg2)
{
    int64_t rax = 0;
    int64_t var_138;
    do
...
int64_t sub_404c20(void* arg1, int64_t arg2, uint64_t arg3)
{
    void* r14 = (arg1 + 0x60);
    uint64_t r13 = arg3;
    int64_t r12 = arg2;
    ...
    if (rbp < arg3)
    {
        *(arg1 + 0xe0) = 0;
        r13 = ((r15 + r13) - 0x80);
        memcpy(rdi, arg2, rbp);
        bool cond0_1 = (*(arg1 + 0x40) - -0x80) <= 0x7f;
        ...
        *(arg1 + 0x48) = (*(arg1 + 0x48) + rax_3);
        ...
        else
        {
            ...
            {
                int64_t rsi_2 = rbp_1;
                bool cond1_1 = (*(arg1 + 0x40) - -0x80) <= 0x7f;
                *(arg1 + 0x40) = (*(arg1 + 0x40) - -0x80);
                int64_t rax_6;
                rax_6 = cond1_1;
                rbp_1 = (rbp_1 - -0x80);
...
int64_t sub_404d50(int64_t* arg1, char* arg2)
{
    arg1[8] = 0;
...
int64_t sub_404e20(int64_t* arg1, int64_t arg2)
{
    if ((arg2 - 1) > 0x3f)
    {
        return 0xffffffff;
...
int64_t sub_404e90(int64_t* arg1, int64_t arg2, int64_t arg3, uint64_t arg4)
{
...
int64_t sub_404f80(void* arg1, int64_t arg2, uint64_t arg3)
{
    if (arg3 == 0)
    {
        return 0;
...
int64_t sub_404fa0(void* arg1, int64_t arg2, int64_t arg3)
{
    int128_t zmm0 = 0;
...
int64_t sub_4050f0(int64_t arg1, int64_t arg2, int64_t arg3, uint64_t arg4, 
...
int64_t j_sub_4050f0(int64_t arg1, int64_t arg2, int64_t arg3, uint64_t arg4, 
    int64_t arg5, uint64_t arg6)
{
    /* tailcall */
...
uint64_t sub_4051d0(FILE* arg1, int64_t arg2, int64_t arg3)
{
...
noreturn int64_t sub_4052c0() 
{
    /* tailcall */
    return sub_403280(1);
}

int64_t sub_4052d0(char* arg1, int64_t* arg2, int64_t arg3, uint64_t arg4)
{
    int64_t rbp = arg3;
...
int64_t sub_4053f0(uint64_t arg1, uint64_t arg2, int64_t arg3)
{
    char* rbx;
    if (arg3 == -1)
    {
...
char* sub_405470(int64_t* arg1, int64_t arg2, uint64_t arg3)
{
    int64_t r14 = 0;
    int64_t rbp = arg2;
    int64_t rbx = 0;
    ...
    if (r12 != 0)
    {
        do
        {
            ...
            r14 = rbp;
            rbp = (rbp + arg3);
            __fprintf_chk(stderr, 1, "n  - %s", sub_407410(r12));
            r12 = arg1[rbx];
        } while (r12 != 0);
    }
...
int64_t sub_405590(uint64_t arg1, char* arg2, int64_t* arg3, int64_t arg4, 
...
int64_t sub_405600(int64_t arg1, int64_t* arg2, int64_t arg3, uint64_t arg4)
{
    int64_t r14 = *arg2;
    if (r14 != 0)
    {
...
int64_t sub_405650(int64_t arg1)
{
    data_60e330 = arg1;
}

int64_t sub_405660(char arg1)
{
    data_60e328 = arg1;
}

void sub_405670(void* arg1)
{
...
int64_t sub_405710(int32_t arg1, int64_t arg2, off64_t arg3, int32_t arg4)
{
    /* tailcall */
    return posix_fadvise(arg1, arg2, arg3, arg4);
}

void sub_405720(FILE* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        return;
...
FILE* sub_405750(char* arg1, char* arg2)
{
...
char* sub_405890(char* arg1, int32_t arg2)
{
...
int64_t sub_405990(char* arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, 
...
char* sub_406bc0(int32_t arg1, uint64_t arg2, uint64_t arg3, int32_t* arg4)
{
    int64_t r15 = arg1;
...
int64_t sub_406d60(int64_t arg1)
{
    int64_t rbx = arg1;
    int32_t* rax = __errno_location();
    int32_t r12 = *rax;
...
uint64_t sub_406da0(int32_t* arg1)
{
    if (arg1 == 0)
    {
        arg1 = &data_60e440;
...
void sub_406db0(int32_t* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        arg1 = &data_60e440;
...
uint64_t sub_406dc0(int64_t arg1, uint8_t arg2, int32_t arg3)
{
    if (arg1 == 0)
    {
        arg1 = 0x60e440;
...
uint64_t sub_406e00(int128_t* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        arg1 = &data_60e440;
...
void sub_406e20(int32_t* arg1, int64_t arg2, int64_t arg3)
{
    if (arg1 == 0)
    {
        arg1 = &data_60e440;
...
int64_t sub_406e50(char* arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, 
    int32_t* arg5)
{
    int32_t* rbx = arg5;
    if (arg5 == 0)
...
char* sub_406ed0(uint64_t arg1, uint64_t arg2, int64_t* arg3, int32_t* arg4)
{
    int32_t* rbx = arg4;
    if (arg4 == 0)
    {
...
int64_t sub_406fc0(uint64_t arg1, uint64_t arg2, int32_t* arg3)
{
    /* tailcall */
...
int64_t sub_407070(int32_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_406bc0(arg1, arg2, -1, &data_60e440);
}

int64_t sub_407090(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_406bc0(arg1, arg2, arg3, &data_60e440);
}

int64_t sub_4070a0(uint64_t arg1)
{
    /* tailcall */
    return sub_406bc0(0, arg1, -1, &data_60e440);
}

int64_t sub_4070c0(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_406bc0(0, arg1, arg2, &data_60e440);
}

char* sub_4070e0(int32_t arg1, int32_t arg2, uint64_t arg3)
{
    if (arg2 == 0xa)
    {
        abort();
...
char* sub_407150(int32_t arg1, int32_t arg2, uint64_t arg3, uint64_t arg4)
{
    if (arg2 == 0xa)
    {
        abort();
...
int64_t sub_4071c0(int32_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_4070e0(0, arg1, arg2);
}

int64_t sub_4071d0(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_407150(0, arg1, arg2, arg3);
}

char* sub_4071e0(uint64_t arg1, uint64_t arg2, uint8_t arg3)
{
...
int64_t sub_407250(uint64_t arg1, uint8_t arg2)
{
    /* tailcall */
    return sub_4071e0(arg1, -1, arg2);
}

int64_t sub_407260(uint64_t arg1)
{
    /* tailcall */
    return sub_4071e0(arg1, -1, 0x3a);
}

int64_t sub_407280(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_4071e0(arg1, arg2, 0x3a);
}

char* sub_407290(int32_t arg1, int32_t arg2, uint64_t arg3)
{
    if (arg2 == 0xa)
    {
        abort();
...
char* sub_407300(int32_t arg1, int64_t arg2, int64_t arg3, uint64_t arg4, 
    uint64_t arg5)
{
    int128_t var_48 = data_60e440;
    int128_t var_38 = data_60e450;
...
int64_t sub_4073f0(int32_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_406bc0(arg1, arg2, -1, &data_60e260);
}

int64_t sub_407410(uint64_t arg1)
{
    /* tailcall */
    return sub_406bc0(0, arg1, -1, &data_60e260);
}

int64_t sub_407430(int32_t arg1)
{
    /* tailcall */
    return sub_408660(arg1, 0, 3);
}

int64_t sub_407440(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
...
int64_t sub_407820(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int64_t* arg5)
{
    int64_t r9 = 0;
    if (*arg5 != 0)
...
int64_t sub_407840(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int32_t* arg5)
{
    int64_t r9 = 0;
    void var_58;
...
int64_t sub_4078a0(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4)
{
    char r11 = 0;
    int64_t r8;
    int64_t var_18 = r8;
...
int64_t sub_4079e0(uint64_t arg1)
{
...
int64_t sub_407a40(int64_t arg1, uint64_t arg2)
{
    if ((arg2 == 0 && arg1 != 0))
    {
        free(arg1);
...
noreturn int64_t sub_407b8a() 
{
    sub_407c30();
    /* no return */
}

int64_t sub_407b90(uint64_t arg1)
{
    /* tailcall */
    return memset(sub_4079e0(arg1), 0, arg1);
}

int64_t sub_407bb0(uint64_t arg1, uint64_t arg2)
{
    int64_t rax;
    bool rdx;
    rdx = HIGHD((arg1 * arg2));
...
int64_t sub_407be0(int64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return memcpy(sub_4079e0(arg2), arg1, arg2);
}

int64_t sub_407c10(char* arg1)
{
    /* tailcall */
    return sub_407be0(arg1, (strlen(arg1) + 1));
}

noreturn int64_t sub_407c30() 
{
...
int64_t sub_407c70(char* arg1, int32_t arg2, int64_t arg3, int64_t arg4, 
...
int64_t sub_407d40(char* arg1, int64_t arg2, int64_t arg3, char* arg4, 
    int64_t arg5, int32_t arg6)
{
    return sub_407c70(arg1, 0xa, arg2, arg3, arg4, arg5, arg6);
}

uint64_t sub_407d70(char* arg1, int64_t* arg2, int32_t arg3, uint64_t* arg4, 
    char* arg5)
{
    if (arg3 > 0x24)
    {
...
uint64_t sub_4081a0(char* arg1, int64_t* arg2, int32_t arg3, uint64_t* arg4, 
    char* arg5)
{
    if (arg3 > 0x24)
    {
...
uint64_t sub_408660(int32_t arg1, int32_t arg2, int32_t arg3)
{
    void* var_58 = &arg_8;
    int64_t rcx;
    int64_t var_30 = rcx;
...
off64_t sub_4087e0(FILE* arg1, off_t arg2, int32_t arg3)
{
...
uint64_t sub_408840(int64_t arg1, int32_t* arg2)
{
    int64_t r11 = (arg1 + 8);
...
uint64_t sub_408920(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
...
uint64_t sub_408f40(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
...
uint64_t sub_409570(int32_t arg1, int64_t* arg2, char* arg3)
{
    return _getopt_internal(arg1, arg2, arg3, nullptr, nullptr, 0, 1);
}

uint64_t sub_409610(uint32_t* arg1, char* arg2, uint64_t arg3, mbstate_t* arg4)
{
    uint64_t rbx_1;
    char* rbp_1;
    uint32_t* r12_1;
...
int64_t sub_409d30(void (* arg1)(void*))
{
...
int64_t sub_409d48(int64_t arg1, int64_t arg2, int64_t arg3)
{
